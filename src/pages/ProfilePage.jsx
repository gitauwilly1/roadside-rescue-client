...
const ProfilePage = () => {
    ...
    const isLikelyGoogleUser = user?.email?.includes('gmail.com') || user?.email?.includes('googlemail.com');
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-blue-600 mt-2">
                                            To set a password for email login, please use the "Forgot Password" option on the login page.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.emailNotifications ? 'bg-red-600' : 'bg-gray-300'
                                        }`}
                                >
                                    <span
                            ...
                            <div className="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.smsNotifications ? 'bg-red-600' : 'bg-gray-300'
                                        }`}
                                >
                                    <span
                            ...
                            <div className="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.jobStatusUpdate ? 'bg-red-600' : 'bg-gray-300'
                                        }`}
                                >
                                    <span
                                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notifications.jobStatusUpdate ? 'translate-x-6' : 'translate-x-1'
                                            }`}
                                    />
                                </button>
                            </div>
                            ...
                            <div className="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.promotionalOffers ? 'bg-red-600' : 'bg-gray-300'
                                        }`}
                                >
                                    <span
                                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notifications.promotionalOffers ? 'translate-x-6' : 'translate-x-1'
                                            }`}
                                    />
                                </button>
                            </div>
