...
const LoginPage = () => {
  ...
  const handleGoogleLogin = () => {
    setError('Google login coming soon! Please use email/phone login for now.');
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-soft py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 animate-fade-in">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-all duration-200 group"
        >
